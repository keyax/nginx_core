...
//      if (err.defaultPrevented) {} // the default was prevented
...
var myHeaders = new Headers({
  ...
  "Access-Control-Allow-Headers": "Origin, Headers, X-Custom-Header, X-Requested-With, Content-Type, Accept, Authorization",
  "Access-Control-Allow-Origin": "*",
  "Access-Control-Allow-Methods": "GET,HEAD,OPTIONS,POST,PUT",
//  "Access-Control-Allow-Headers": "Headers, Accept, Content-Type",
//  "Access-Control-Request-Headers": "X-Custom-Header, Origin, Content-Type, Accept",
  "Content-Type": "application/json",
...
/*({
  "Access-Control-Request-Headers": "X-Custom-Header, Origin, Content-Type",
  "Accept": "application/json",
  "Content-Type": "application/json",
  "Access-Control-Allow-Headers": "Accept, Content-Type"
  //Methods, Headers, Origin, Accept, Content-Type',
...
*/
var init = { method: 'POST', mode: 'cors',
// TypeError: NetworkError when attempting to fetch resource. cors missing
// TypeError: 'mode' member of RequestInit 'basic' is not a valid value for enumeration RequestMode.
// opaque: Response for “no-cors” request to cross-origin resource. Severely restricted.
// TypeError: 'mode' member of RequestInit 'opaque' is not a valid value for enumeration RequestMode.
  //           body: JSON.stringify(data),
               headers: myHeaders,
               cache: 'default' };  //reload

//var req = new Request(uri, init);
fetch(uri, init).then(function(response) {
// response.headers.set("Access-Control-Request-Headers", "X-Custom-Header, Origin, Content-Type");

    console.log("mimetype"+ response.type + response.body);
  return response.body;}).then(function(json) {
  processData(json);
});
        ...
        if (xhr.status == 200
         ...
         && xhr.responseText !== null)
             ...
             processData(xhr.responseText);
              ...
              console.log("datalog + data"); // something went wrong
             }
    };
